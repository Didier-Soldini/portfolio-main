...
const skillItems = [
  ...
  { id: 2, category: 'outils', title: 'Github', icon: SiGithub, bg_color: 'linear-gradient(225deg,#eaeaea .14%,#b7b7b7 99.86%)' },
  ...
  { id: 7, category: 'front', title: 'Bootstrap', icon: SiBootstrap, bg_color: 'linear-gradient(225deg,#a134e8 .14%,#a966ff 99.86%)' },
  ...
  { id: 10, category: 'front', title: 'Redux', icon: SiRedux, bg_color: 'linear-gradient(225deg,#99daff .14%,#a966ff 99.86%)' },
